...
int ContourToolProcess::doTask(ContourUtility &contourUtility, UINT8 *contourResultAndBitmap, size_t *bufSize){
	...
	// 将更新的评分结果填充到结构体中
	ivsContourResult.toolScore = finalResult.score * percent;
